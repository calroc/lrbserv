# Django settings for lrbserv project.
import os
DEBUG = True
...
# Let's not mess with uppercase letters in tags.
...
SECRET_KEY = 'y=@(uuo(cmosxb)=x=*_^(s(lhm5tk3h8*3!srxm=c(=%el9ol'
